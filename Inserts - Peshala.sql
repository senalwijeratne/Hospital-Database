...
('3','Janitor',3000,'JA','Janitor. Keep buildings in clean and orderly condition. Perform heavy cleaning duties, such as cleaning floors, shampooing rugs, washing walls and glass, and removing rubbish.'),
('4','Diatesian',55000,'DI','promote good dietary health and treat medical conditions by devising eating plans for patients based on the science of nutrition'),
...
('8','Attendees',75000,'AT','Attending for the needs of the patients'),
('9','Nurse',80000,'NU','. Nurses plan and provide medical and nursing care to patients in hospital');
