...
('1','1','1','Tasia','Gauvin','Thilakasiri','M','182','kongama lane','Willpalla',0777505279,01129174396,2014/06/28),
('1','1','1','Mollie ','Fosdick','Thilakasiri','F','252','jayagama','Willpalla',0774595409,0111354155,2014/09/06),
('1','1','1','Ethan ','Hillebrand','Thilakasiri','M','381','weera lane','Willpalla'0778123126,0115122718,2015/04/21),
('1','1','1','Uthpala','Wijerathne','Thilakasiri','M','152','jayawardhanapura','kotte',0713010822,0111613999,2016/10/02),
('1','1','1','Judah','Josiah Holmes','Justice, Carson B','F','82','kibulawala','homagaama',761708675,0115673695,2016/03/21),
('1','1','1','Nathan','Kenneth Shepard','Ray, Carol Q.','M','22','manipur','koongama',0768702458,0111413465,2015/02/09),
('1','1','1','Boris','Vladimir Higgins','Armstrong, Gloria R.','F','28','hongama','Willpalla'0714135152,0119508117,2015/05/31),
('1','1','1','Craig','Brendan Murray','Roberts, Nicholas F','M','82','galmaduwa','walikada',0775763819,0113898879,2015/04/22),
('1','1','1','Ivan','Howard Palmer','Prince, Thane N.','F','281','rukmala lane','rukmalgama',0711727065,0115172748,22-04-15);
